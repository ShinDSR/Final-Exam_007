...
import model.entity.exceptions.NonexistentEntityException;
import model.entity.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("wws.b.finalexam_finalexam_jar_0.0.1-SNAPSHOTPU");
